...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "**🔍 ตรวจช้างก่อนเดินทาง!** เช็คความปลอดภัยก่อนออกเดินทางที่นี่ 👉 [คลิกเลย](https://aprlabtop.com/Honey_test/map_1.php)",
        "**🛡️ ป้องกันช้างบนถนน** ดูข้อมูลช้างป่าล่วงหน้าเพื่อความปลอดภัยของคุณ 👉 [ดูเพิ่มเติม](https://aprlabtop.com/Honey_test/map_1.php)",
        "**🚗 ขับขี่ปลอดภัยจากช้างป่า** ตรวจสอบพื้นที่มีช้างหรือไม่ก่อนออกเดินทาง 👉 [ตรวจสอบเลย](https://aprlabtop.com/Honey_test/map_1.php)",
        "**🌿 ช้างป่าไม่ใช่ปัญหา** ใช้ AI ของเราเช็คช้างก่อนเดินทาง 👉 [เริ่มเลย](https://aprlabtop.com/Honey_test/map_1.php)",
        "**👀 มองเห็นช้างก่อนถนน** เพิ่มความปลอดภัยด้วยการตรวจช้างล่วงหน้า 👉 [เข้าดู](https://aprlabtop.com/Honey_test/map_1.php)",
        "**📍 แผนที่ช้างป่า** หาตำแหน่งช้างก่อนเดินทางของคุณ 👉 [สำรวจแผนที่](https://aprlabtop.com/Honey_test/map_1.php)",
        "**🔔 เตือนช้างบนถนน** รับการแจ้งเตือนเมื่อมีช้างในพื้นที่ 👉 [สมัครรับข้อมูล](https://aprlabtop.com/Honey_test/map_1.php)",
        "**✨ ความปลอดภัยเป็นเรื่องสำคัญ** เช็คช้างป่าก่อนออกเดินทางทุกครั้ง 👉 [คลิกที่นี่](https://aprlabtop.com/Honey_test/map_1.php)",
        "**🦁 ปกป้องชีวิตจากช้างป่า** ใช้เทคโนโลยี AI เพื่อความปลอดภัยของคุณ 👉 [เรียนรู้เพิ่มเติม](https://aprlabtop.com/Honey_test/map_1.php)",
        "**🌐 เชื่อมต่อกับความปลอดภัย** ตรวจสอบช้างป่าผ่านระบบ AI ของเรา 👉 [เข้าร่วมตอนนี้](https://aprlabtop.com/Honey_test/map_1.php)",
    ]
