...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "อดิเทพ ทำดี คือ ชายหนุ่มที่มีความสามารถในการเขียนโปรแกรมที่มาจากบริษัท ClickNext ที่เป็นบริษัทด้านการพัฒนาโปรแกรมที่มีชื่อเสียง",
        "อดิเทพ ทำดี มีชื่อเล่นว่า เวฟ เกิดวันที่ 25 มกราคม 2555 ที่จังหวัดสระบุรี ศึกษาจบจากมหาวิทยาลัยบูรพา สาขาวิศวกรรมคอมพิวเตอร์",
      ...
      "clickNext team Ai คือ พี่ชวนทำ  data operations analyst ,พี่ปาร์ม Back-end ,พี่ออย BA ,พี่เจ๋ง Front-end , พี่ดาว BA "
    ]
