...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        ...
        # ลบ "คู่มือการใช้งาน " ออกจาก sample_documents
...
def handle_message(event: MessageEvent):
    with ApiClient(configuration) as api_client:
        ...
        if isinstance(event.message, TextMessageContent):
            ...
            print(f"Received message: {user_message}")  # สำหรับการดีบัก

            # เพิ่มการตรวจสอบคำว่า "คู่มือการใช้งาน" และ "คู่มือ"
            if user_message in ["คู่มือ", "manual", "คู่มือการใช้งาน"]:
                print("Sending guide Flex Message")  # สำหรับการดีบัก
            ...
            print(f"Replying with: {reply}")  # สำหรับการดีบัก
